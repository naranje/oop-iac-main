...
import { ProductionWebsiteConfigurationStrategy } from '../constructs/strategies/production-website-configuration-strategy';
...
export class ProductionStage extends cdk.Stage {
    constructor(scope: Construct, id: string, props: ProductionStageProps) {
        ...
        const websiteConfigurationStrategy = new ProductionWebsiteConfigurationStrategy({
            domainName: props.domainName,
            websiteFolder: '../application/frontend/dist/todo-application',  
            subdomain: 'todo'}
         );
        const frontendStack = new FrontendStack(this, 'FrontendStack', {websiteConfigurationStrategy: websiteConfigurationStrategy});
